...
- [Simple Router](https://github.com/DioxusLabs/dioxus/tree/main/examples/06-routing/simple_router.rs) — Basic routing setup
- [Router](https://github.com/DioxusLabs/dioxus/tree/main/examples/06-routing/router.rs) — Advanced router with layouts and redirects
- [Link](https://github.com/DioxusLabs/dioxus/tree/main/examples/06-routing/link.rs) — Navigation with the Link component
- [Flat Router](https://github.com/DioxusLabs/dioxus/tree/main/examples/06-routing/flat_router.rs) — Simple flat route structure
