---
title: "Миграция: Fermi"
---

# Fermi

В dioxus 0.5 атомы fermi были заменены глобальными сигналами и включены в основную библиотеку dioxus.


Новые глобальные сигналы можно использовать напрямую без хуков и включают дополнительную функциональность, такую как глобальные мемо (global memos).
...
Dioxus 0.5 вводит глобальные мемо, которые можно использовать для хранения вычисляемых значений глобально.
