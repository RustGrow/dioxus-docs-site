...
Now our HotDog app uses a full-fledged SQLite database for persistent storage of favorite dog photos! The database is created automatically on the first server run.
