...
If you are ready to dive into building your own renderer for dioxus, the [custom renderer guide](./utilities/custom-renderer.md) provides an overview of how to get started.

## Changelog

For a history of patch releases and what changed in each version, see the [Changelog](./changelog.md).
