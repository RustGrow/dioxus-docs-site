...
As of Dioxus 0.7.6, the CLI supports generating shell completions for bash, zsh, fish, and PowerShell:
...
This enables tab-completion for all `dx` subcommands and flags in your terminal.
