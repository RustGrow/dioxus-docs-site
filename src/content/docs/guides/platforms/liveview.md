...
Dioxus liveview will be migrated to [dioxus-fullstack](../../essentials/fullstack/index.md) in a future release. Once this migration occurs, you may need to update your code. We plan for this migration to be minimal.
...
Because of this, with the liveview renderer you need to be very deliberate about managing latency. Events that would be fast enough on other renderers like [controlled inputs](../../essentials/basics/event-handlers.md), can be frustrating to use in the liveview renderer.
