...
You can read more about the new props API in the [Props Migration](to-05-props.md) guide.
...
Read more about the `use_resource` hook in the [Hook Migration](to-05-hooks.md) guide.
...
Read more about the `use_signal` hook in the [State Migration](to-05-state.md) guide.
